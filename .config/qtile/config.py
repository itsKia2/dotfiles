...
keys = [
    ...
    Key([mod, "shift"], "x", lazy.spawn("sh /home/kia/.config/rofi/powermenu/powermenu.sh"), desc="Shutdown Options"),
    # Key([mod], "r", lazy.spawncmd(), desc="Spawn a command using a prompt widget"),
    Key([mod], "d", lazy.spawn(rofi), desc="spawn rofi"),
...
screens = [
    Screen(
        wallpaper = '/home/kia/Pictures/bluetrees.jpg',
        wallpaper_mode = 'fill',
        bottom=bar.Bar(
            [
                ...
                widget.TextBox("everything is awesome", name="default"),
                widget.Sep(),
